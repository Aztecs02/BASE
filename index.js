	...
	try {
		...
		if (anu.action == 'add') {
			...
			try {
               ...
               buttonText:{displayText: 'Oke\n*AKU MAU KASIH TAU KALO AKU ANAK HASIL ZINA*'},type:1}], options = {contextInfo: {mentionedJid: [num, htod]}})
			...
			try {
				...
				sendButImage(anu.jid, teks, ``, img,but = [{buttonId: `Hello World!`, buttonText: {displayText: `SABAR YA\nSAYANG KAMU CUMAN KEHILANGAN PANGKAT ADMIN BUKAN KEHILANGAN AKU🗿`}, type: 1}], options = {contextInfo: {mentionedJid: [num]}})
